...
const StartWivard_3 = () => {
  return (
    <>
      <div class="row justify-content-center px-3 px-sm-4">
        <div class="col text-center mb-2">
          ...
          <header className="masthead pt-3 px-3 px-sm-4">
            <div className="inner">
              ...
              />
              <a
                className="float-right text-right pt-2 pr-0 text-muted"
                href="#"
              >
                Log in
              </a>
              ...
              <fieldset>
                <div className="form-card">
                  <div className="my-0 bd-callout bd-callout-warning mb-3">
                    You will be able to add more details by logging in to the
                    full TL desktop version
                  </div>
                  ...
                  <ul className="list-group" id="items2">
                    ...
                    <li className="list-group-item">
                      ...
                      <div className="ml-3a pl-3">
                        <i className="far fa-file-alt ml-n3"></i> Hong, et. al.
                        v. Suavei, Inc., Infante and Wong
                      </div>
                    </li>
                    <li className="list-group-item">
                      <button className="btn btn-danger btn-sm float-right delete">
                      ...
                      <div className="ml-3a pl-custom">
                        <i className="far fa-folder ml-n-custom"></i> Web design
                        for West side project
                      </div>
